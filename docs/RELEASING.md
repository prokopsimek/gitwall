...
3. Review notes: explain that Gitwall is a menu bar app without a Dock icon
   (`LSUIElement`), how to add an account (a personal access token for a public demo
   repository is enough) and how to add the widget (right-click the desktop >
   Edit Widgets > Gitwall).
4. Submit for review.
...
- Screenshots for Mac: PNG without alpha, 16:10, one of 1280×800, 1440×900, 2560×1600
  or 2880×1800 pixels. Upload 2880×1800 (Retina capture of a 1440×900 area). Suggested
  set: popover with a view, widgets on the desktop, view editor in Settings, a notification.
